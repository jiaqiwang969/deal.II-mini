...
namespace DesignPattern
{
    ...
    namespace Prototype
    {
        ...
        /**
         * ConcretePrototype1是Prototype的一个子类，实现了Clone方法
         * 在这个例子中，Prototype类的所有数据成员都在堆栈中。如果你的属性中有指针，例如：String*
         * name_
         * ，你将需要实现Copy-Constructor以确保你有一个来自clone方法的深度拷贝。
         */
        ...
        public:
            ...
            /**
             * Notice here that you just need to specify the type of the
             * prototype you want and the method will create from the object
             * with this type.
             */
