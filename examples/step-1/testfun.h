...
// 一个简单的单元测试框架，定义了两个类 TestCase 和
// UnitTest，以及一系列用于测试的宏
...
void UnitTest::Run()
{
  for (auto it : testcases_)
    {
      ...
      testcase->nPassed     = 0;
      deallog << "============================================\n";
      deallog << " Run TestCase:" << testcase->testcase_name << std::endl;
      testcase->Run();
      if (testcase->nFailed == 0)
        deallog << " FAILE ";
      else
        deallog << " PASS ";
      deallog << " " << testcase->nPassed << " / "
  ...
  deallog << "============================================\n";
  deallog << " Total TestCase : " << nPassed + nFailed << std::endl;
  deallog << " Total Passed : " << nPassed << std::endl;
  deallog << " Total Failed : " << nFailed << std::endl;
  deallog << " " << nPassed << " / " << nFailed + nPassed
...
#define DEALII_TEST_(testcase_name)                         \
  class TESTCASE_NAME(testcase_name)                        \
    : public TestCase                                       \
  {                                                         \
  public:                                                   \
  ...
  do                                                                 \
    {                                                                \
      if (!Condition)                                                \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_FALSE succeeded!\n";                   \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << "  EXPECT_FALSE failed!\n";                     \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      if (v1 == v2)                                                  \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_EQ succeeded!\n";                      \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_EQ failed!\n";                         \
          deallog << " Expect:" << v1 << std::endl;                  \
          deallog << " Actual:" << v2 << std::endl;                  \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      if (v1 != v2)                                                  \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_NE succeeded!\n";                      \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_NE failed!\n";                         \
          deallog << " Expect:" << v1 << std::endl;                  \
          deallog << " Actual:" << v2 << std::endl;                  \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      if (v1 < v2)                                                   \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_LT succeeded!\n";                      \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_LT failed!\n";                         \
          deallog << " Expect:" << v1 << std::endl;                  \
          deallog << " Actual:" << v2 << std::endl;                  \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      if (v1 <= v2)                                                  \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_LE succeeded!\n";                      \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_LE failed!\n";                         \
          deallog << " Expect:" << v1 << std::endl;                  \
          deallog << " Actual:" << v2 << std::endl;                  \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      if (v1 > v2)                                                   \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_GT succeeded!\n";                      \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_GT failed!\n";                         \
          deallog << " Expect:" << v1 << std::endl;                  \
          deallog << " Actual:" << v2 << std::endl;                  \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      if (v1 >= v2)                                                  \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_GE succeeded!\n";                      \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_GE failed!\n";                         \
          deallog << " Expect:" << v1 << std::endl;                  \
          deallog << " Actual:" << v2 << std::endl;                  \
        }                                                            \
  } while (0)
      ...
      if (s1 == NULL || s2 == NULL)                                      \
        {                                                                \
          if (s1 != NULL || s2 != NULL)                                  \
            {                                                            \
              UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
              deallog << " EXPECT_STRNE succeeded!\n";                   \
            }                                                            \
          else                                                           \
            {                                                            \
              UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
              UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
              deallog << " EXPECT_STRNE failed!\n";                      \
              if (s1 == NULL)                                            \
                deallog << " Expect: NULL\n";                            \
              else                                                       \
                deallog << " Expect:\"" << s1 << "\"\n";                 \
...
EXPECT_PTR_RANGE_EQ(p1, p2, len) 验证条件: 任意 i (*p1 + i) == (*p2 + i)
i∈[0,len) EXPECT_PTR_RANGE_NE(p1, p2, len) 验证条件: 存在 i (*p1 + i) != (*p2 +
i)  i∈[0,len)
  ...
  do                                                                 \
    {                                                                \
      if (*p1 == *p2)                                                \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_PTR_EQ succeeded!\n";                  \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_PTR_EQ failed!\n";                     \
          deallog << " Expect:" << *p1 << std::endl;                 \
          deallog << " Actual:" << *p2 << std::endl;                 \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      if (*p1 != *p2)                                                \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_PTR_NE succeeded!\n";                  \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_PTR_NE failed!\n";                     \
          deallog << " Expect:" << *p1 << std::endl;                 \
          deallog << " Actual:" << *p2 << std::endl;                 \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      if (std::equal(p1, p1 + len, p2))                              \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_PTR_RANGE_EQ succeeded!\n";            \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_PTR_RANGE_EQ failed!\n";               \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      if (!std::equal(p1, p1 + len, p2))                             \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_PTR_RANGE_NE succeeded!\n";            \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_PTR_RANGE_NE failed!\n";               \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      ...
      if (first1 == last1 && first2 == last2)                        \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_CON_EQ succeeded!\n";                  \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_CON_EQ failed!\n";                     \
          deallog << " Expect:" << *first1 << std::endl;             \
          deallog << " Actual:" << *first2 << std::endl;             \
        }                                                            \
  } while (0)
  ...
  do                                                                 \
    {                                                                \
      ...
      if (first1 != last1 || first2 != last2)                        \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nPassed++;       \
          deallog << " EXPECT_CON_NE succeeded!\n";                  \
        }                                                            \
      else                                                           \
        {                                                            \
          UnitTest::GetInstance()->CurrentTestCase->nTestResult = 0; \
          UnitTest::GetInstance()->CurrentTestCase->nFailed++;       \
          deallog << " EXPECT_CON_NE failed!\n";                     \
        }                                                            \
  } while (0)
...
// 简单测试的宏定义
#define TEST(testcase_name) DEALII_TEST_(testcase_name)
